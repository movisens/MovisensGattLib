...
public class MovisensCharacteristics
{
	...
	public static final Characteristic<CommandResult> COMMAND_RESULT = new Characteristic<CommandResult>("3cd05e3a-4e2c-4d6c-bee8-f02ffdbc32ea", "Command Result", CommandResult.class);
	...
	public static final Characteristic<PakeClientConfirm1> PAKE_CLIENT_CONFIRM_1 = new Characteristic<PakeClientConfirm1>("3b837ed9-6745-41fb-aab7-14b0586ca156", "Pake Client Confirm 1", PakeClientConfirm1.class);
	public static final Characteristic<PakeClientConfirm2> PAKE_CLIENT_CONFIRM_2 = new Characteristic<PakeClientConfirm2>("b56e61f6-e55d-4f16-8aa2-123992275a71", "Pake Client Confirm 2", PakeClientConfirm2.class);
	public static final Characteristic<PakeClientShare1> PAKE_CLIENT_SHARE_1 = new Characteristic<PakeClientShare1>("61492296-8ab0-4601-901e-786f63f185be", "Pake Client Share 1", PakeClientShare1.class);
	public static final Characteristic<PakeClientShare2> PAKE_CLIENT_SHARE_2 = new Characteristic<PakeClientShare2>("43595228-25a4-47da-8580-cf1fc3bb9d1a", "Pake Client Share 2", PakeClientShare2.class);
	public static final Characteristic<PakeSensorConfirm1> PAKE_SENSOR_CONFIRM_1 = new Characteristic<PakeSensorConfirm1>("9e005280-f04b-4645-a0a9-61a6221e5c80", "Pake Sensor Confirm 1", PakeSensorConfirm1.class);
	...
	public static final Characteristic<SecurityCapabilities> SECURITY_CAPABILITIES = new Characteristic<SecurityCapabilities>("266a3428-b284-4780-aafa-255c4233867a", "Security Capabilities", SecurityCapabilities.class);
	...
	public static final BufferedCharacteristic<MetBuffered, MetData> MET_BUFFERED = new BufferedCharacteristic<MetBuffered, MetData>("82e947c3-48a2-4106-8536-b3bdc6b10453", "Met Buffered", 8, MetBuffered.class, com.movisens.movisensgattlib.MovisensCharacteristics.AGE_FLOAT, com.movisens.smartgattlib.Characteristics.GENDER, com.movisens.smartgattlib.Characteristics.WEIGHT, com.movisens.smartgattlib.Characteristics.HEIGHT, com.movisens.movisensgattlib.MovisensCharacteristics.SENSOR_LOCATION);
	public static final Characteristic<MetLevel> MET_LEVEL = new Characteristic<MetLevel>("114dc370-a5d0-4d86-a701-030282a0a271", "Met Level", MetLevel.class, com.movisens.movisensgattlib.MovisensCharacteristics.AGE_FLOAT, com.movisens.smartgattlib.Characteristics.GENDER, com.movisens.smartgattlib.Characteristics.WEIGHT, com.movisens.smartgattlib.Characteristics.HEIGHT, com.movisens.movisensgattlib.MovisensCharacteristics.SENSOR_LOCATION);
	public static final BufferedCharacteristic<MetLevelBuffered, MetLevelData> MET_LEVEL_BUFFERED = new BufferedCharacteristic<MetLevelBuffered, MetLevelData>("7ba991c9-dfa6-4776-9002-6c9696f90e14", "Met Level Buffered", 9, MetLevelBuffered.class, com.movisens.movisensgattlib.MovisensCharacteristics.AGE_FLOAT, com.movisens.smartgattlib.Characteristics.GENDER, com.movisens.smartgattlib.Characteristics.WEIGHT, com.movisens.smartgattlib.Characteristics.HEIGHT, com.movisens.movisensgattlib.MovisensCharacteristics.SENSOR_LOCATION);
	...
	static
	{
		...
		characteristics.put(COMMAND_RESULT);
		...
		characteristics.put(PAKE_CLIENT_CONFIRM_1);
		characteristics.put(PAKE_CLIENT_CONFIRM_2);
		characteristics.put(PAKE_CLIENT_SHARE_1);
		characteristics.put(PAKE_CLIENT_SHARE_2);
		characteristics.put(PAKE_SENSOR_CONFIRM_1);
		...
		characteristics.put(SECURITY_CAPABILITIES);
