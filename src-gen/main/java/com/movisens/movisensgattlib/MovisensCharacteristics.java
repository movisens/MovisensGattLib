...
import com.movisens.movisensgattlib.attributes.CurrentDrain;
import com.movisens.movisensgattlib.attributes.CurrentDrainBuffered;
import com.movisens.movisensgattlib.attributes.CurrentDrainWaiting;
...
import com.movisens.movisensgattlib.attributes.EdaCountsBuffered;
...
import com.movisens.movisensgattlib.attributes.LightBuffered;
import com.movisens.movisensgattlib.attributes.LightWaiting;
import com.movisens.movisensgattlib.attributes.LightRgb;
import com.movisens.movisensgattlib.attributes.LightRgbBuffered;
import com.movisens.movisensgattlib.attributes.LightRgbWaiting;
import com.movisens.movisensgattlib.attributes.ColorTemperature;
import com.movisens.movisensgattlib.attributes.ColorTemperatureBuffered;
...
import com.movisens.movisensgattlib.attributes.IlluminationBuffered;
...
public class MovisensCharacteristics
{
	...
	public static final Characteristic BODY_POSITION_BUFFERED = new Characteristic("fda6f11e-a1d0-41da-b611-5ab3ec34f6ca", "Body Position Buffered", BodyPositionBuffered.class);
	...
	public static final Characteristic COLOR_TEMPERATURE_BUFFERED = new Characteristic("8478339d-6687-42b8-9478-6a825d31bfeb", "Color Temperature Buffered", ColorTemperatureBuffered.class);
	...
	public static final Characteristic CURRENT_DRAIN = new Characteristic("690e309f-0248-469c-b049-ee29b8230842", "Current Drain", CurrentDrain.class);
	public static final Characteristic CURRENT_DRAIN_BUFFERED = new Characteristic("80a36368-e30f-4b4e-a2ec-c5ba68958648", "Current Drain Buffered", CurrentDrainBuffered.class);
	public static final Characteristic CURRENT_DRAIN_WAITING = new Characteristic("732fbd29-2603-4807-b5d5-acdb773648c0", "Current Drain Waiting", CurrentDrainWaiting.class);
	...
	public static final Characteristic EDA_COUNTS_BUFFERED = new Characteristic("9c60e32c-9f59-4a4c-a0f2-f346c13b5bbb", "Eda Counts Buffered", EdaCountsBuffered.class);
	...
	public static final Characteristic EDA_SCL_MEAN_BUFFERED = new Characteristic("663af1bc-2fa0-43c0-b452-2b8c1efb7f9d", "Eda Scl Mean Buffered", EdaSclMeanBuffered.class);
	...
	public static final Characteristic HR_MEAN_BUFFERED = new Characteristic("1d9533d1-8c6e-4b6a-b242-d0713be204f0", "Hr Mean Buffered", HrMeanBuffered.class);
	...
	public static final Characteristic HRV_IS_VALID_BUFFERED = new Characteristic("0524f2f1-d8da-4ef6-9e3b-43d6ed0ec518", "Hrv Is Valid Buffered", HrvIsValidBuffered.class);
	...
	public static final Characteristic ILLUMINATION_BUFFERED = new Characteristic("162de980-b426-425d-8df0-602fba83e6b9", "Illumination Buffered", IlluminationBuffered.class);
	...
	public static final Characteristic INCLINATION = new Characteristic("e165b5d0-d83f-4a5c-86a6-306ca1ddf0ef", "Inclination", Inclination.class);
	...
	public static final Characteristic LIGHT_BUFFERED = new Characteristic("7e5dd77b-67b7-42dd-be7a-822373391b2f", "Light Buffered", LightBuffered.class);
	public static final Characteristic LIGHT_RGB = new Characteristic("db32d0ca-fda0-4298-9d2f-1b109eb95a2f", "Light RGB", LightRgb.class);
	public static final Characteristic LIGHT_RGB_BUFFERED = new Characteristic("2c4abbf8-8da6-4e47-afcd-18034d67c5ee", "Light RGB buffered", LightRgbBuffered.class);
	public static final Characteristic LIGHT_RGB_WAITING = new Characteristic("c758f5a6-516d-4125-b8de-ae3ebcabeabc", "Light RGB waiting", LightRgbWaiting.class);
