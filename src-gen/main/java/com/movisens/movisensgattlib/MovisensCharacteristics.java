...
import com.movisens.movisensgattlib.attributes.Pim;
import com.movisens.movisensgattlib.attributes.PimWaiting;
import com.movisens.movisensgattlib.attributes.Zcm;
import com.movisens.movisensgattlib.attributes.ZcmWaiting;
import com.movisens.movisensgattlib.attributes.Inclination;
...
import com.movisens.movisensgattlib.attributes.SkinTemperatureBuffered10;
...
public class MovisensCharacteristics
{
	...
	public static final Characteristic INCLINATION = new Characteristic("f89edebf-9b5b-486d-054f-b3ce3e226d49", "Inclination", Inclination.class);
	...
	public static final Characteristic PIM = new Characteristic("f89edebc-0267-c40c-be23-515de4ec781e", "Pim", Pim.class);
	...
	public static final Characteristic SKIN_TEMPERATURE_BUFFERED__1_0 = new Characteristic("99ebde23-1b3e-4084-85c2-18bca6eb5a1a", "Skin Temperature Buffered  1 0", SkinTemperatureBuffered10.class);
	...
	public static final Characteristic ZCM = new Characteristic("f89edebe-0136-7900-2cec-b4641bb709f5", "Zcm", Zcm.class);
	...
	static
	{
		...
		characteristics.put(SKIN_TEMPERATURE_BUFFERED__1_0);
