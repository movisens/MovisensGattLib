...
public class Inclination extends AbstractReadAttribute
{
	...
	public String toString()
	{
		...
		{
			result += "Inclination: " + "time=" + new SimpleDateFormat("dd.MM.yyyy HH:mm:ss").format(new Date((time + (periodLength * i)) * 1000)) + "x = " + getX()[i] + " " + getXUnit() + ", " + "y = " + getY()[i] + " " + getYUnit() + ", " + "z = " + getZ()[i] + " " + getZUnit() + "\r\n";
		}
		return result;
	}
}
